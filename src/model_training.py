...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try:
            ...
            raise CustomException(f"Failed to load and split the data", e)
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            ...
            logger.info(f"Best model is {best_lgbm_model}")
            return best_lgbm_model
        except Exception as e:
            logger.error(f"Error while hyperparameter tuning {e}")
            raise CustomException(f"Failed to complete hyperparameter tuning", e)
    ...
    def evaluate_model(self, model, X_test, y_test):
        try:
            ...
            logger.error(f"Error while evaluating lgbm model {e}")
            raise CustomException(f"Failed to complete lgbm model evaluation", e)
    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info("MLFlow experimentation starting")
